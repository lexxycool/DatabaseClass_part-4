...
public class ExercisesTests {
	...
	public static void setupDataSource() throws SQLException {
		...
		dataSource.setUrl("jdbc:postgresql://localhost:5432/moviedbtemp");
		dataSource.setUsername("postgres");
		dataSource.setPassword("postgres1");
		dataSource.setAutoCommit(false); //So we can rollback after each test.

		ScriptUtils.executeSqlScript(dataSource.getConnection(), new ClassPathResource("MovieDBTemp-data.psql"));
